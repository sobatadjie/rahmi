                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                     <router-link to="/chart"><a href="shopping-cart.html" class="primary-btn pd-cart">Add To Cart</a></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
...
import HeaderRahmi from '@/components/HeaderRahmi.vue'
import RelatedRahmi from '@/components/RelatedRahmi.vue'
import FooterRahmi from '@/components/FooterRahmi.vue'
